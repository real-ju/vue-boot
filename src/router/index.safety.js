...
import { getEnvParams, asyncViewImport } from '@/config/util'

Vue.use(Router);

const APP_NAME = getEnvParams('appName');
            ...
            .then(res => {
                ...
                datas.forEach(item => {
                    adminRoutes.push({
                        ...
                        component: asyncViewImport(`admin/${item.common ? 'common' : userPlatform.symbol}/${item.name}/index.vue`)
                    })
                })
